...
This repository is designed as a portfolio-grade ML systems example aligned with a senior practitioner background (Physics PhD, 10+ years in data science). It emphasizes the engineering discipline expected in production ML teams: modular architecture, reproducibility, testing, and lightweight governance.
